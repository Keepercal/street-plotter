const BASEMAPS = {
	...
	openstreetmap: {
		...
		preview: '/street-plotter/images/osm.png',
	},
	satellite: {
		name: 'Satellite',
		url: 'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}',
		attribution: '&copy; Esri',
		preview: '/street-plotter/images/satellite.png',
	},
};
